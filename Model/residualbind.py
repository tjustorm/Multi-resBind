...
def ResidualBind(input_shape=(150, 14), num_class=27, classification=None, attention_module=None):
        ...
        def residual_block(input_layer, filter_size, activation='relu',
            ...
            for f in factor:
                ...
                nn = keras.layers.BatchNormalization()(nn)
            se_layer = attach_attention_module(input_layer, attention_module)
            nn = keras.layers.add([se_layer, nn])
